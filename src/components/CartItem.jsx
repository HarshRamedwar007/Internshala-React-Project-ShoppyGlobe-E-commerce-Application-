    ...
    return (
        <article className="flex flex-col min-[500px]:flex-row gap-x-5 shadow-lg max-w-[700px] rounded-lg">
            ...
            <article className="min-[500px]:ml-auto mr-5 mt-4 flex flex-row min-[500px]:flex-col gap-x-3 min-[500px]:gap-y-1">
                <button onClick={incrementQuantity} className="bg-purple-700 text-white rounded-md w-[60px] py-[8px]">+</button>
                <input
                    type="number"
                    value={data.quantity}
                    readOnly
                ...
                />
                <button onClick={decrementQuantity} className="bg-purple-700 text-white rounded-md w-[60px] py-[8px] mt-1">-</button>
            </article>
        </article>
    )
}
